...
export const DELIVERY_DAY_OPTIONS: { value: string; label: string }[] = [
  { value: "mon", label: "Mon" },
  { value: "tue", label: "Tue" },
  { value: "wed", label: "Wed" },
  { value: "thu", label: "Thu" },
...
const ALL_DAYS = DELIVERY_DAY_OPTIONS.map((d) => d.value);
...
// skip rendering anything instead of showing a fake/default claim.
